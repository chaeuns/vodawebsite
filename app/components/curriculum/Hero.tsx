        ...
        <div className="relative max-w-[1100px] px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24 py-6 md:py-8">
          <div className="-translate-y-5">
            ...
            >
              ...
              <span className="align-middle">정부 교육 사업</span>
            </p>
          ...
          <p className="hero-fade-3 text-[#111827] mt-4 leading-[1.6] text-[13px] md:text-[15px] max-w-[90%] md:max-w-[520px]">
            AI·보안·클라우드 등 실무 중심 커리큘럼으로 <br className="md:hidden" />
            정부 지원 교육 과정을 운영합니다. <br className="hidden md:block" />
            수강생 개인의 <br className="md:hidden" />
            성장을 데이터로 추적하고 취업까지 함께합니다.
          </p>
        </div>
      </section>
    </>
