...
export const faqs = [
  ...
  },
  {
    ...
    a: "프론트엔드, 백엔드, AI/머신러닝, 클라우드·인프라 분야 중 하나 이상에서 실무 경력 및 프로젝트 경험을 보유하신 분을 우대합니다. 관련 직무 경험이 있으시거나, 해당 분야의 포트폴리오 또는 강의·멘토링 이력이 있으신 분이라면 더욱 환영합니다.",
  },
  {
    q: "Q. 프로젝트 강사는 일반 강사와 어떻게 다른가요?",
    a: "일반 강사가 이론 및 기술 개념 중심의 강의를 담당한다면, 프로젝트 강사는 실무 수준의 팀 프로젝트를 설계하고 직접 이끄는 역할을 합니다. 기획부터 배포까지 전 과정을 학습자와 함께하며, 현장 감각과 문제 해결 능력을 키울 수 있도록 지도합니다. 프론트엔드·백엔드·AI·클라우드 등 특정 분야의 실무 프로젝트 경험이 풍부하신 분이 적합합니다.",
  },
  {
    q: "Q. 멘토는 어떠한 일을 하는 건가요?",
    a: "멘토는 학생들에게 지식을 전달하고, 실무형 프로젝트 경험을 쌓을 수 있도록 돕습니다. 학생들의 진로 및 직업에 대한 조언을 해주는 역할을 하며, 학생들의 성장과 성공을 위해 함께 최선을 다해주실 분을 기다립니다.",
  },
];
